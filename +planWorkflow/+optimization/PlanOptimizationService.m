    ...
    methods (Static, Access = private)
        ...
        function warnWarmStartSkipped(dij,pln)
            ...
            radiationMode = ...
                ...
                pln,'radiationMode');
            quantityOpt = ...
                planWorkflow.optimization.PlanOptimizationService.bioParamFieldText( ...
                pln,'quantityOpt');
            if strcmp(quantityOpt,'<unknown>')
                quantityOpt = ...
                    planWorkflow.optimization.PlanOptimizationService.fieldText( ...
                    pln,'quantityOpt');
            end
            ...
            warning('planWorkflow:optimization:WarmStartSkipped', ...
                ['Skipping matRad warm start for biological optimization ' ...
                 'because dij.ax/dij.bx are incompatible with matRad''s ' ...
                 'warm-start branch. reason=%s, radiationMode=%s, ' ...
        ...
        function value = bioParamFieldText(pln,fieldName)
            value = '<unknown>';
            if ~planWorkflow.optimization.PlanOptimizationService.hasMember( ...
                    pln,'bioParam')
                return;
