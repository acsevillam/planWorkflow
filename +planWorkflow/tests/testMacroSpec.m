...
function testDosePullingStep1LimitFollowsSite(testCase)
breastSpec = macroSpecCatalog('breast.photons.4136_mct.COWC', ...
    'profile','testing');
prostateSpec = macroSpecCatalog('prostate.photons.3482.INTERVAL2', ...
    'profile','testing');
headNeckSpec = macroSpecCatalog('head_and_neck.photons.2.INTERVAL2', ...
    'profile','testing');

verifyEqual(testCase, ...
    [breastSpec.pullDose.step1Limit ...
     prostateSpec.pullDose.step1Limit ...
     headNeckSpec.pullDose.step1Limit], ...
    [0.95 0.98 0.90]);
end
