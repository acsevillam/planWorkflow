...
function testCCowcVariantP2CannotExceedScenarioCount(testCase)
plan = cleanPlan('ccowc','c-COWC');
plan.robustnessMode = 'c-COWC';
plan.scenario = struct('mode','wcScen','ctActive',true, ...
    'setupActive',true,'rangeActive',false,'gantryActive',false, ...
    'couchActive',false);
plan.variants = struct('id','p1_1_p2_8','label','p1=1 - p2=8', ...
    'p1',1,'p2',8);

verifyError(testCase,@() ...
    planWorkflow.config.RobustPlanConfig.normalizePlans( ...
    plan,contract('c-COWC',false)), ...
