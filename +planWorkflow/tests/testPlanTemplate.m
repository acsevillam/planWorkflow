...
verifyEqual(testCase,{comparisonTemplate.objectiveSets.robustPlans.id}, ...
    {'PTV','Minimax','Stochastic','cMinimax','MeanVarianceP1', ...
    'MeanVarianceP5','MeanVarianceP10','MeanVarianceP20', ...
    'MeanVarianceP30','Interval2','Interval3'});
verifyEqual(testCase,{comparisonTemplate.objectiveSets.robustPlans.label}, ...
    {'PTV','COWC','Stochastic','c-Minimax', ...
    'MeanVariance (Penalty=1)','MeanVariance (Penalty=5)', ...
    'MeanVariance (Penalty=10)','MeanVariance (Penalty=20)', ...
    'MeanVariance (Penalty=30)','Interval2','Interval3'});
