...
verifyEqual(testCase, ...
    ...
    'STOCH','nomScen'), ...
    {'label','robustness','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'COWC','nomScen'), ...
    {'label','robustness','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'c-COWC','nomScen'), ...
    {'label','robustness','p1','p2','scen_mode','ctActive', ...
    'ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'INTERVAL2','nomScen'), ...
    {'label','robustness','theta1','radiusMode','useStreaming', ...
    'SecondPassStrategy','KeepCache','CacheRoot','scen_mode', ...
    'ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'INTERVAL3','nomScen'), ...
    {'label','robustness','theta1','theta2','radiusMode','KMode', ...
    'kmax','retentionThreshold','useStreaming','SecondPassStrategy', ...
    'KeepCache','CacheRoot','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'INTERVAL3','nomScen',struct(),'static'), ...
    {'label','robustness','theta1','theta2','radiusMode','KMode', ...
    'kmax','useStreaming','SecondPassStrategy','KeepCache', ...
    'CacheRoot','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'INTERVAL3','nomScen',struct(),'dynamic','extreme'), ...
    {'label','robustness','theta1','theta2','radiusMode', ...
    'useStreaming','SecondPassStrategy','KeepCache','CacheRoot', ...
    'scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'PROB2','nomScen'), ...
    {'label','robustness','useStreaming','SecondPassStrategy', ...
    'KeepCache','CacheRoot','scen_mode','ctActive','ctScenProb'});
end
...
plan.dosePrecompute.useStreaming = true;
...
verifyTrue(testCase,panelConfig.useStreaming);
...
cacheRoot = fullfile(tempdir,'planWorkflow_prob2_cache');
runConfig = baseRunConfig();
runConfig.precompute.reference.robustnessMode = 'PROB2';
runConfig.precompute.reference.dosePrecompute.useStreaming = true;
...
verifyTrue(testCase,panelConfig.reference_useStreaming);
...
verifyEqual(testCase, ...
    ...
    'reference_kmax', ...
    'reference_retentionThreshold','reference_useStreaming', ...
...
verifyEqual(testCase, ...
    ...
    'reference_theta2','reference_radiusMode','reference_KMode', ...
    'reference_kmax', ...
    'reference_useStreaming','reference_SecondPassStrategy', ...
...
verifyEqual(testCase, ...
    ...
    'INTERVAL3','nomScen',struct(),'dynamic','extreme'), ...
    {'reference_label','reference_robustness','reference_theta1', ...
    'reference_theta2','reference_radiusMode','reference_useStreaming', ...
    'reference_SecondPassStrategy','reference_KeepCache', ...
