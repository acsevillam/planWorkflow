...
verifyEqual(testCase, ...
    ...
    'MemoryLimitMB','MemoryLimitFraction','MemoryLimitFallbackMB', ...
...
verifyEqual(testCase, ...
    ...
    'SecondPassStrategy','KeepCache','CacheRoot','MemoryLimitMB', ...
    'MemoryLimitFraction','MemoryLimitFallbackMB','scen_mode','ctActive', ...
    'ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    ...
    'KeepCache','CacheRoot','MemoryLimitMB','MemoryLimitFraction', ...
    'MemoryLimitFallbackMB','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'INTERVAL3','nomScen',struct(),'dynamic','extreme'), ...
    {'label','robustness','variantSummary','theta1','theta2', ...
    'radiusMode','useScenarioBatch','SecondPassStrategy','KeepCache', ...
    'CacheRoot','MemoryLimitMB','MemoryLimitFraction', ...
    'MemoryLimitFallbackMB','scen_mode','ctActive','ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeRobustParameterFields( ...
    'PROB2','nomScen'), ...
...
verifyEqual(testCase, ...
    ...
    'reference_CacheRoot','reference_MemoryLimitMB', ...
    'reference_MemoryLimitFraction','reference_MemoryLimitFallbackMB', ...
...
verifyEqual(testCase, ...
    ...
    'reference_MemoryLimitMB','reference_MemoryLimitFraction', ...
    'reference_MemoryLimitFallbackMB', ...
    'reference_scen_mode','reference_ctActive','reference_ctScenProb'});
verifyEqual(testCase, ...
    planWorkflow.config.WorkflowParameterSchema.precomputeReferenceParameterFields( ...
    'INTERVAL3','nomScen',struct(),'dynamic','extreme'), ...
...
verifyEqual(testCase,data{ctvRow,4}, ...
    planWorkflow.gui.TemplateStructureTableAdapter.colorText([1 0 1]));
