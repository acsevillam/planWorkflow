classdef DoseInfluenceCacheService
            ...
            switch char(ref.cacheKind)
                ...
                case 'interval'
                    dij = obj.loadCompactRef(ref,owner,rootData, ...
                        'interval');
                case 'prob2'
                    dij = obj.loadCompactRef(ref,owner,rootData,'prob2');
            end
    ...
    methods (Access = private)
        function dij = loadStandardRef(obj,ref,owner)
            ...
            pln = ...
                ...
                ref,owner);
            if ~obj.isCompatible(cached,pln,ref.tag,cacheContext)
            ...
            switch char(cacheKind)
                case 'interval'
                    ...
                    cacheContext = ...
                        ...
                        context,owner);
                case 'prob2'
                    variables = {'dij_prob2','dijProb2Context', ...
                        'cacheMetadata'};
                    tag = ...
    ...
    methods (Static)
        ...
        function assertKnownRefKind(ref)
            validKinds = {'standard','interval','prob2'};
        ...
        function assertCacheRefMetadata(ref,cacheMetadata,cacheFile)
            ...
            if ~isfield(cacheMetadata,'tag') || ...
                    ~strcmp(char(cacheMetadata.tag),char(ref.tag))
                error(['planWorkflow:cache:DoseInfluenceCacheService:' ...
