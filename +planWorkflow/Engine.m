    ...
    methods (Access = protected)
        ...
        function runConfig = normalizeRunConfig(obj,runConfig,effectiveTemplate)
            ...
            runConfig.optimizerOptions = ...
                ...
                runConfig.optimizerOptions);
            runConfig.resources = ...
                planWorkflow.config.Resources.normalize(runConfig.resources);
        ...
        function rejectUnsupportedConfigFields(obj,runConfig)
            unsupportedFields = { ...
                ...
                'doseWindowExpectedDoseDifference', ...
                'gammaWindow', ...
                'gammaCriteria', ...
                'robustnessCriteria', ...
            ...
            replacements = { ...
                ...
                'resources.sampling.workerUpperBound or resources.sampling.autoLimitWorkers', ...
        ...
        function stageConfig = normalizeStageConfig(obj,stageName,stageConfig)
            switch stageName
                ...
                case 'optimize'
                    ...
                    if isfield(stageConfig,'optimizerOptions')
                        stageConfig.optimizerOptions = ...
                            planWorkflow.config.OptimizerOptions.normalize( ...
                            stageConfig.optimizerOptions);
                    end
                case 'sample'
