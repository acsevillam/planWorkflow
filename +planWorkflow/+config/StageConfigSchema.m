    ...
    methods (Static)
        ...
        function [configField,value] = valueFromRunConfig( ...
            ...
            switch char(stageName)
                ...
                case 'analysis'
                    if strcmp(fieldName,'figuresSliceControl') && ...
                            isfield(runConfig,'analysis') && ...
                            isfield(runConfig.analysis,'figures') && ...
                            isfield(runConfig.analysis.figures,'sliceControl')
                        configField = 'figures.sliceControl';
                        value = runConfig.analysis.figures.sliceControl;
                    elseif isfield(runConfig,'analysis') && ...
