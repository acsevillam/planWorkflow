classdef RobustPlanConfig
    ...
    methods (Static)
        ...
        function plan = defaultPlan()
            ...
            plan = struct( ...
                ...
                'requiresProbDij',contract.requiresProbDij, ...
                'optimization4D', ...
                planWorkflow.config.RobustPlanConfig.defaultOptimization4D(), ...
                'scenario', ...
                planWorkflow.config.RobustPlanConfig.defaultScenario( ...
        ...
        function dosePrecompute = defaultDosePrecompute()
            dosePrecompute = struct( ...
                'useScenarioBatch',false, ...
                'SecondPassStrategy','disk', ...
                'KeepCache',false, ...
                'CacheRoot','', ...
                'MemoryLimitMB','auto', ...
                'MemoryLimitFraction',0.50, ...
        ...
        function plan = normalizePlan(plan,planIx,contract)
            ...
            planWorkflow.config.RobustPlanCatalog.validatePlanVariantsForScenario( ...
                plan,sprintf('config.precompute.robustPlans(%d)',planIx));
        end
        ...
        function dosePrecompute = normalizeDosePrecompute( ...
            ...
            allowed = {'useScenarioBatch','SecondPassStrategy','KeepCache', ...
            ...
            dosePrecompute = ...
                ...
                dosePrecompute, ...
                planWorkflow.config.RobustPlanConfig.defaultDosePrecompute());
            dosePrecompute.useScenarioBatch = ...
                planWorkflow.config.ConfigValue.logicalScalar( ...
                dosePrecompute.useScenarioBatch,[context '.useScenarioBatch'], ...
                'planWorkflow:config:RobustPlanConfig:InvalidLogical');
            dosePrecompute.KeepCache = ...
                planWorkflow.config.ConfigValue.logicalScalar( ...
            ...
            dosePrecompute.MemoryLimitMB = ...
                planWorkflow.config.RobustPlanConfig.memoryLimitMB( ...
                dosePrecompute.MemoryLimitMB,[context '.MemoryLimitMB']);
            dosePrecompute.MemoryLimitFraction = ...
                planWorkflow.config.RobustPlanConfig.fractionScalar( ...
                dosePrecompute.MemoryLimitFraction, ...
                [context '.MemoryLimitFraction']);
            dosePrecompute.MemoryLimitFallbackMB = ...
                planWorkflow.config.RobustPlanConfig.positiveScalar( ...
                dosePrecompute.MemoryLimitFallbackMB, ...
                [context '.MemoryLimitFallbackMB']);
        end
    ...
    methods (Static, Access = private)
        ...
        function assertSingleCompactPrecomputeMode(plan,context)
            ...
            requiresProb = isfield(plan,'requiresProbDij') && ...
                logical(plan.requiresProbDij);
            if requiresInterval && requiresProb
                error(['planWorkflow:config:RobustPlanConfig:' ...
        ...
        function value = memoryLimitMB(value,context)
            ...
            error('planWorkflow:config:RobustPlanConfig:InvalidMemoryLimit', ...
                '%s must be a positive finite scalar or ''auto''.',context);
        end

        function value = fractionScalar(value,context)
            if ~(isnumeric(value) && isscalar(value) && isfinite(value) && ...
                    value > 0 && value <= 1)
                error(['planWorkflow:config:RobustPlanConfig:' ...
                    'InvalidMemoryLimitFraction'], ...
                    '%s must be a finite scalar in (0,1].',context);
            end
            value = double(value);
        end

        function value = positiveScalar(value,context)
            if ~(isnumeric(value) && isscalar(value) && isfinite(value) && ...
                    value > 0)
                error(['planWorkflow:config:RobustPlanConfig:' ...
                    'InvalidPositiveScalar'], ...
                    '%s must be a positive finite scalar.',context);
            end
            value = double(value);
        end
