    ...
    methods (Static)
        ...
        function assertNoLegacyFields(config,context)
            legacyFields = {'robustness','robust_scen_mode', ...
                ...
                'retentionThreshold'};
            replacements = {'objectives.properties.robustness', ...
                'scenario.mode','variants.p1','variants.p2', ...
                'variants.theta1','variants.theta2', ...
                'robustnessOptions.KMode','robustnessOptions.kmax', ...
                'robustnessOptions.retentionThreshold'};
            legacyFields = [{'strategy','strategyOptions'},legacyFields];
            replacements = [{'objectives.properties.robustness', ...
                'robustnessOptions'},replacements];
