    ...
    methods (Static)
        ...
        function doseCube = robustCenterDoseCube(resultGUI,robustData)
            ...
            if isfield(robustData,'dij_prob2') && ...
                    isfield(robustData.dij_prob2,'expected') && ...
                    isfield(robustData,'dijProb2Context') && ...
                    isfield(robustData.dijProb2Context,'doseGrid') && ...
                    isfield(resultGUI,'w')
                doseVector = robustData.dij_prob2.expected * resultGUI.w;
                doseCube = reshape(full(doseVector), ...
