    ...
    methods (Static)
        ...
        function doseCube = robustCenterDoseCube(resultGUI,robustData)
            if isfield(robustData,'dij_interval') && ...
                    ...
                    isfield(robustData,'dijIntervalContext') && ...
                    isfield(robustData.dijIntervalContext,'doseGrid') && ...
                    isfield(resultGUI,'w')
            ...
            if isfield(robustData,'dij_prob') && ...
                    isfield(robustData.dij_prob,'expected') && ...
                    isfield(robustData,'dijProbContext') && ...
                    isfield(robustData.dijProbContext,'doseGrid') && ...
                    isfield(resultGUI,'w')
                doseVector = robustData.dij_prob.expected * resultGUI.w;
                doseCube = reshape(full(doseVector), ...
                    robustData.dijProbContext.doseGrid.dimensions);
                return;
            end
