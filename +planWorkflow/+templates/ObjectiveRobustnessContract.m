classdef ObjectiveRobustnessContract
    ...
    methods (Static)
        function contract = forObjectiveSet(objectiveSet)
            ...
            if numel(nonNone) > 1
                if all(ismember(nonNone,{'INTERVAL2','INTERVAL3'}))
                    robustnessMode = 'INTERVAL3';
                else
