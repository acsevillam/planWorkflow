classdef SyntheticWorkflow < robOpt.WorkflowBase
    % SyntheticWorkflow Minimal workflow used by robOpt unit tests.
    ...
    methods (Access = protected)
        function runConfig = defaultRunConfig(~)
            ...
            runConfig.cacheRootPath = fullfile(tempdir,'robOpt-cache');
        end
        ...
        function strategy = resolveStrategy(~,strategyName)
            switch char(strategyName)
                ...
                otherwise
                    error('robOptTest:SyntheticWorkflow:UnknownStrategy', ...
