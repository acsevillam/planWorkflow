    ...
    methods (Static)
        function expectedQi = fromCstStat(cstStat,cst,pln,doseMode)
            ...
            for i = 1:numel(cstStat)
                ...
                expectedQi(i).mean = robOpt.analysis.ExpectedQi.meanDoseFromDvh( ...
                    doseGrid,volumePoints);
                expectedQi(i).std = robOpt.analysis.ExpectedQi.stdDoseFromDvh( ...
                    doseGrid,volumePoints);
                expectedQi(i).min = robOpt.analysis.ExpectedQi.minDoseFromDvh( ...
                    doseGrid,volumePoints);
                expectedQi(i).max = robOpt.analysis.ExpectedQi.maxDoseFromDvh( ...
                    doseGrid,volumePoints);
                expectedQi(i).D_95 = robOpt.analysis.ExpectedQi.dvhDoseAtVolume( ...
                    doseGrid,volumePoints,95);
                expectedQi(i).D_98 = robOpt.analysis.ExpectedQi.dvhDoseAtVolume( ...
                    doseGrid,volumePoints,98);
                expectedQi(i).D_2 = robOpt.analysis.ExpectedQi.dvhDoseAtVolume( ...
                    doseGrid,volumePoints,2);
                expectedQi(i).D_50 = robOpt.analysis.ExpectedQi.dvhDoseAtVolume( ...
                    doseGrid,volumePoints,50);
                expectedQi(i).V_17_1Gy = robOpt.analysis.ExpectedQi.dvhVolumeAtDose( ...
                    doseGrid,volumePoints,17.1);
                expectedQi(i).V_34_3Gy = robOpt.analysis.ExpectedQi.dvhVolumeAtDose( ...
        ...
        function stdDose = stdDoseFromDvh(doseGrid,volumePoints)
            survival = volumePoints(:) / 100;
            meanDose = robOpt.analysis.ExpectedQi.meanDoseFromDvh( ...
