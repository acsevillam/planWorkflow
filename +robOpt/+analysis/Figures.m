    ...
    methods (Static)
        function figureFiles = saveSamplingAnalysisFigures(analysisFolder,label, ...
            ...
            figureFiles = struct( ...
                ...
                'dvhMultiscenario','', ...
                'dvhTrustband','');
            displayDoseScale = robOpt.analysis.Figures.displayDoseScale( ...
                sample.pln,analysis);
            ...
            figureFiles.meanDose = robOpt.analysis.Figures.saveDoseStatisticFigure( ...
                samplingData.ct,samplingData.cst,doseStat.meanCubeW * displayDoseScale, ...
            ...
            figureFiles.stdDose = robOpt.analysis.Figures.saveDoseStatisticFigure( ...
                samplingData.ct,samplingData.cst,doseStat.stdCubeW * displayDoseScale, ...
            ...
            figureFiles.dvhMultiscenario = ...
                ...
                samplingData.cst,sample,displayDoseScale,analysis.doseWindowDvh, ...
                'multiscenario', ...
        ...
        function scale = displayDoseScale(pln,analysis)
            scale = matRad_getDisplayDoseScale(pln,analysis.displayDoseMode);
        end
